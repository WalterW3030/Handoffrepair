...
# lock contents (~64GB bf16); ctx 24576 = workload max ~20.6k tokens + ~19% margin (user decision 2026-08-29, choice 1-A); audit: for ToolSandbox (avg episode ~11.6k tok; R13 audit 2026-08-28: +11.8 GiB headroom at util 0.90).
...
PORT="${PORT:-8000}"
exec docker run --name serve_qwen3_32b --gpus '"'"device=$GPU_ID"'"' \
